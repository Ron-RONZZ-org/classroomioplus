...
- **AI Provider settings** (`/org/{slug}/settings/ai-provider`): provider-profile CRUD (add/save/delete) is a fork addition; verifies the page loads and profiles persist.
