...
<svelte:head>
  <title>Reset Password - LibreClassroom</title>
</svelte:head>
  ...
  <div class="flex flex-col items-center gap-4">
    <Avatar.Root>
      <Avatar.Image
        ...
        alt={$currentOrg.name ? $currentOrg.name : 'LibreClassroom'}
      />
      <Avatar.Fallback>{$currentOrg.name ? $currentOrg.name : 'LibreClassroom'}</Avatar.Fallback>
    </Avatar.Root>
