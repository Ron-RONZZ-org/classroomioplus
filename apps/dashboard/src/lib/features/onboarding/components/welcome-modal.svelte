<script>
  ...
  import { APP_NAME, BRAND_ROOT_DOMAIN } from '$lib/utils/constants/branding';
...
>
  <Dialog.Content class="w-[700px]! max-w-none!">
    ...
    <p class="text-md text-black dark:text-white">
      ...
      <a href="https://{BRAND_ROOT_DOMAIN}/" class="ui:text-primary no-underline hover:no-underline">{APP_NAME}</a>
